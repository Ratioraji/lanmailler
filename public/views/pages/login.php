    ...
    <body>
        ...
        <div class="login-container">
            ...
            <div class="login-box animated fadeInDown">
                <div class="login-logo" style="margin-bottom:80px;margin-top:0px;text-align:center !important;" ><img src="<?php echo base_url(); ?>assets/img/logo.fw_-1.png" class="" ></div>
                ...
                <div class="login-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" class="form-control" required="true" placeholder="Username" name="uemail" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <a href="<?php echo base_url(); ?>forgot-password" class="btn btn-link btn-block">Forgot your password?</a>
                        </div>
                        <div class="col-md-6">
