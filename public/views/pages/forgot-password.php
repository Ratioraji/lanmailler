        ...
        <div class="login-container">
            ...
            <div class="login-box animated fadeInDown">
                ...
                <div class="login-body">
                    ...
                    <div class="login-title"><strong>Forget Password</strong>, Please enter your email address or username</div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <a href="<?php echo base_url() ?>admin/login" class="btn btn-link btn-block">Login </a>
                        </div>
                        <div class="col-md-6">
