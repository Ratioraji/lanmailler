                ...
                <div class="content-frame">                                    
                    ...
                    <div class="content-frame-top">                        
                        <div class="page-title">                    
                            <h2><span class="fa fa-star"></span> Stared <small>(<?php if(isset($num_starred)){ echo $num_starred ;}else { echo 0 ;}?>)</small></h2>
                        </div>                                                                                
                    ...
                    <div class="content-frame-left">
                        ...
                        <div class="block">
                            <div class="list-group border-bottom">
								<a href="<?php echo base_url() ?>message-inbox" class="list-group-item "><span class="fa fa-inbox"></span> Inbox <span class="badge badge-success"><?php if(isset($num_inbox)){ echo $num_inbox ;}else { echo 0 ;}?></span></a>
                                <a href="<?php echo base_url() ?>message-stared" class="list-group-item active"><span class="fa fa-star"></span> Starred <span class="badge badge-warning"><?php if(isset($num_starred)){ echo $num_starred ;}else { echo 0 ;}?></span></a>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body mail">
                                <?php  
                                 if(count($inbox) > 0 )	
								 {
									foreach($inbox as $message)
									{
										...
										$stat_starred = $message->starred_stat ;
								...
								<?php		
									...
									<p class="text-center "><span class="fa fa-trash" > </span> No Messages found</p> 
