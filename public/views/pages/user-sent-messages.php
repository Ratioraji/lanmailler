                ...
                <div class="content-frame">                                    
                    ...
                    <div class="content-frame-top">                        
                        <div class="page-title">                    
                            <h2><span class="fa fa-rocket"></span> Sent <small></small></h2>
                        </div>                                                                                
                        ...
                        <div class="block">
                            <div class="list-group border-bottom">
                               <a href="<?php echo base_url() ?>message-inbox" class="list-group-item "><span class="fa fa-inbox"></span> Inbox <span class="badge badge-success"><?php if(isset($num_inbox)){ echo $num_inbox ;}else { echo 0 ;}?></span></a>
                                ...
                                <a href="<?php echo base_url() ?>message-sent" class="list-group-item active"><span class="fa fa-rocket"></span> Sent</a>
