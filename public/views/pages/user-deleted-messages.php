                ...
                <div class="content-frame">                                    
                    ...
                    <div class="content-frame-top">                        
                        <div class="page-title">                    
                            <h2><span class="fa fa-trash-o"></span> Deleted <small>(30 )</small></h2>
                        </div>                                                                                
                    ...
                    <div class="content-frame-left">
                        ...
                        <div class="block">
                            <div class="list-group border-bottom">
                                ...
                                <a href="<?php echo base_url() ?>message-deleted" class="list-group-item active"><span class="fa fa-trash-o"></span> Deleted <span class="badge badge-default"><?php if(isset($num_deleted)){ echo $num_deleted ;}else { echo 0 ;}?></span></a>                            
                            </div>                        
                        </div>
                        <!-- <div class="block">
                            <h4>Labels</h4>
                            ...
                            <div class="panel-body mail">
                               ...
                               <?php  
								...
								<?php		
									...
									<p class="text-center "><span class="fa fa-trash" > </span> No Deleted Messages</p> 
